    ...
    <>
      <div>
        ...
        <div className="container m-auto flex flex-wrap">
          <div className="text-white lg:w-1/2 w-full lg:h-[600px] flex justify-center sm:items-center sm:p-0 p-6 ">
            <div className="md:w-1/2 bg-yellow-20 text-center sm:text-left">
              <h2 className="text-3xl md:text-4xl uppercase text-gray-300">
          ...
          <div className="lg:w-1/2 w-full lg:h-[600px] flex justify-center items-center right-sec">
            <div
            ...
            >
              <NavLink to={"/destination"}>
                <p className="xl:px-[60px] xl:py-[100px] text-3xl rounded-full">
                  EXPLORE
                </p>
              </NavLink>
            </div>
